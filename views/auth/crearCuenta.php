            ...
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6" action="/crear-cuenta" method="post">
                    ...
                    <div class="mt-10 text-sm text-gray-400 ">
                        <h2>Al crear la cuenta el usuario recibira un mensaje a su correo para activar su cuenta,
                            tambien recibira una contraseña
                            temporal, la cual debera cambiar.</h2>
                    </div>
