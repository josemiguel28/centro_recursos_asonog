    ...
    <div class="max-w-screen-2xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5 mb-10">
            ...
            <a href="/usuario?mode=INS"
               class="flex items-center gap-5 p-5 bg-white border border-gray-200 rounded-xl shadow-sm hover:border-gray-300 hover:shadow-md transition-all">
                <div class="flex-shrink-0 w-12 h-12 flex items-center justify-center rounded-xl bg-gray-100">
                ...
                <div>
                    <p class="text-sm font-semibold text-gray-900">Crear Usuario</p>
                    <p class="text-xs text-gray-500 mt-0.5">Añadir un nuevo usuario</p>
                </div>
            </a>
            ...
            <a href="/libro?mode=INS"
               class="flex items-center gap-5 p-5 bg-white border border-gray-200 rounded-xl shadow-sm hover:border-gray-300 hover:shadow-md transition-all">
                ...
                <div>
                    <p class="text-sm font-semibold text-gray-900">Agregar Libro</p>
                    <p class="text-xs text-gray-500 mt-0.5">Registrar un nuevo libro</p>
                </div>
            </a>
            ...
            <a href="/documento?mode=INS"
               class="flex items-center gap-5 p-5 bg-white border border-gray-200 rounded-xl shadow-sm hover:border-gray-300 hover:shadow-md transition-all">
                ...
                <div>
                    <p class="text-sm font-semibold text-gray-900">Agregar Documento</p>
                    <p class="text-xs text-gray-500 mt-0.5">Registrar un nuevo documento</p>
                </div>
            </a>
            ...
            <a href="/usuarios/gestionar"
               class="flex items-center gap-5 p-5 bg-white border border-gray-200 rounded-xl shadow-sm hover:border-gray-300 hover:shadow-md transition-all">
                ...
                <div>
                    <p class="text-sm font-semibold text-gray-900">Gestión de Usuarios</p>
                    <p class="text-xs text-gray-500 mt-0.5">Administrar usuarios existentes</p>
                </div>
            </a>
            ...
            <a href="/gestionar/libros"
               class="flex items-center gap-5 p-5 bg-white border border-gray-200 rounded-xl shadow-sm hover:border-gray-300 hover:shadow-md transition-all">
                ...
                <div>
                    <p class="text-sm font-semibold text-gray-900">Gestión de Libros</p>
                    <p class="text-xs text-gray-500 mt-0.5">Administrar libros existentes</p>
                </div>
            </a>
            ...
            <a href="/repositorio/gestionar"
               class="flex items-center gap-5 p-5 bg-white border border-gray-200 rounded-xl shadow-sm hover:border-gray-300 hover:shadow-md transition-all">
                <div class="flex-shrink-0 w-12 h-12 flex items-center justify-center rounded-xl bg-gray-100">
                    <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 34 32">
                        <g fill="#374151">
                ...
                <div>
                    <p class="text-sm font-semibold text-gray-900">Gestión de Documentos</p>
                    <p class="text-xs text-gray-500 mt-0.5">Administrar documentos existentes</p>
                </div>
            </a>
            ...
            <a href="https://analytics.google.com/analytics/web/?utm_source=marketingplatform.google.com&utm_medium=et&utm_campaign=marketingplatform.google.com%2Fabout%2Fanalytics%2F#/p452859533/reports/intelligenthome?params=_u..nav%3Dmaui"
               ...
               class="flex items-center gap-5 p-5 bg-white border border-gray-200 rounded-xl shadow-sm hover:border-gray-300 hover:shadow-md transition-all">
                ...
                <div>
                    <p class="text-sm font-semibold text-gray-900">Estadísticas</p>
                    <p class="text-xs text-gray-500 mt-0.5">Google Analytics</p>
                </div>
            </a>
                        ...
                        <?php foreach ($accessLog as $log): ?>
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-4 py-3 text-gray-500 whitespace-nowrap">
                                    <?= date("d \d\\e F \d\\e Y, g:i A", strtotime($log->fecha_acceso)) ?>
                                </td>
                            </tr>
                        <?php endforeach ?>
                    </tbody>
