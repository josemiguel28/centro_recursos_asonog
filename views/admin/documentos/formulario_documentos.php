    ...
    <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto lg:py-0">
        ...
        <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0">
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6" action="/documento?mode=<?= $mode ?>&id= <?= $documento->id ?>"
                                ...
                                <?php foreach ($tecnicos as $responsable): ?>
                                    <li>
                                        <div class="flex items-center p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-600">
                                            <input id="checkbox-item-<?= $responsable->id ?>" type="checkbox"
                                                   value="<?= $responsable->id ?>"
                                                   class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500"
                                                   name="id_tecnico_responsable[]">
                                            <label for="checkbox-item-<?= $responsable->id ?>"
                                                   class="w-full ms-2 text-sm font-medium text-gray-900 rounded dark:text-gray-300"><?= $responsable->nombre ?></label>
                                        </div>
                                    </li>
                                <?php endforeach; ?>
                            </ul>
