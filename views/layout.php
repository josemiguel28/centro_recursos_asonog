...
<head>
    ...
    <title>CRGC <?= $titlePage ? "| " . $titlePage: ""; ?> </title>
    <meta name="description" content="Descubre una amplia selección de libros digitales en nuestra biblioteca. Encuentra los títulos más destacados, explora diferentes géneros y accede a recursos exclusivos solo para miembros.">
    <meta name="keywords" content="libros digitales, biblioteca online, libros destacados, libros electrónicos, lectura, recursos educativos, genero, inclusion, derechos humanos, cambio climatico, seguridad alimentaria, SAN ,asonog, ASONOG, centro de recursos">

    <!-- Open Graph Meta Tags -->
    <meta property="og:title" content="Descubre los Libros Más Destacados de Nuestra Biblioteca" />
    <meta property="og:description" content="Explora una amplia colección de libros digitales y físicos. Encuentra títulos exclusivos, desde clásicos hasta novedades, solo para miembros." />
